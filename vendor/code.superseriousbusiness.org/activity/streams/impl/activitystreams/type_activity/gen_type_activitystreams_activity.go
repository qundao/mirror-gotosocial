...
func ActivityIsExtendedBy(other vocab.Type) bool {
	extensions := []string{"Accept", "Add", "Announce", "AnnounceRequest", "Arrive", "Block", "Create", "Delete", "Dislike", "EmojiReact", "Flag", "Follow", "Ignore", "IntransitiveActivity", "Invite", "Join", "Leave", "Like", "LikeRequest", "Listen", "Move", "Offer", "Question", "QuoteRequest", "Read", "Reject", "Remove", "ReplyRequest", "TentativeAccept", "TentativeReject", "Travel", "Undo", "Update", "View"}
