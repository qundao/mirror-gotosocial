...
func (this ActivityStreamsResultPropertyIterator) GetGoToSocialQuoteAuthorization() vocab.GoToSocialQuoteAuthorization {
...
// return an arbitrary value.
func (this ActivityStreamsResultPropertyIterator) GetGoToSocialQuoteRequest() vocab.GoToSocialQuoteRequest {
...
func (this ActivityStreamsResultPropertyIterator) IsGoToSocialQuoteAuthorization() bool {
...
func (this ActivityStreamsResultPropertyIterator) IsGoToSocialQuoteRequest() bool {
...
func (this *ActivityStreamsResultPropertyIterator) SetGoToSocialQuoteAuthorization(v vocab.GoToSocialQuoteAuthorization) {
	this.clear()
...
func (this *ActivityStreamsResultPropertyIterator) SetGoToSocialQuoteRequest(v vocab.GoToSocialQuoteRequest) {
	this.clear()
...
// back of a list of the property "result". Invalidates iterators that are
// traversing using Prev.
func (this *ActivityStreamsResultProperty) AppendGoToSocialQuoteAuthorization(v vocab.GoToSocialQuoteAuthorization) {
	this.properties = append(this.properties, &ActivityStreamsResultPropertyIterator{
		alias:                              this.alias,
		gotosocialQuoteAuthorizationMember: v,
		myIdx:                              this.Len(),
...
// of the property "result". Invalidates iterators that are traversing using
// Prev.
func (this *ActivityStreamsResultProperty) AppendGoToSocialQuoteRequest(v vocab.GoToSocialQuoteRequest) {
	this.properties = append(this.properties, &ActivityStreamsResultPropertyIterator{
		alias:                        this.alias,
		gotosocialQuoteRequestMember: v,
		myIdx:                        this.Len(),
...
// specified index for a property "result". Existing elements at that index
// and higher are shifted back once. Invalidates all iterators.
func (this *ActivityStreamsResultProperty) InsertGoToSocialQuoteAuthorization(idx int, v vocab.GoToSocialQuoteAuthorization) {
	this.properties = append(this.properties, nil)
	copy(this.properties[idx+1:], this.properties[idx:])
	this.properties[idx] = &ActivityStreamsResultPropertyIterator{
		alias:                              this.alias,
...
// index for a property "result". Existing elements at that index and higher
// are shifted back once. Invalidates all iterators.
func (this *ActivityStreamsResultProperty) InsertGoToSocialQuoteRequest(idx int, v vocab.GoToSocialQuoteRequest) {
	this.properties = append(this.properties, nil)
	copy(this.properties[idx+1:], this.properties[idx:])
	this.properties[idx] = &ActivityStreamsResultPropertyIterator{
		alias:                        this.alias,
...
// front of a list of the property "result". Invalidates all iterators.
func (this *ActivityStreamsResultProperty) PrependGoToSocialQuoteAuthorization(v vocab.GoToSocialQuoteAuthorization) {
	this.properties = append([]*ActivityStreamsResultPropertyIterator{{
		alias:                              this.alias,
		gotosocialQuoteAuthorizationMember: v,
		myIdx:                              0,
...
// list of the property "result". Invalidates all iterators.
func (this *ActivityStreamsResultProperty) PrependGoToSocialQuoteRequest(v vocab.GoToSocialQuoteRequest) {
	this.properties = append([]*ActivityStreamsResultPropertyIterator{{
		alias:                        this.alias,
		gotosocialQuoteRequestMember: v,
		myIdx:                        0,
...
// specified index for the property "result". Panics if the index is out of
// bounds. Invalidates all iterators.
func (this *ActivityStreamsResultProperty) SetGoToSocialQuoteAuthorization(idx int, v vocab.GoToSocialQuoteAuthorization) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ActivityStreamsResultPropertyIterator{
		alias:                              this.alias,
		gotosocialQuoteAuthorizationMember: v,
...
// index for the property "result". Panics if the index is out of bounds.
// Invalidates all iterators.
func (this *ActivityStreamsResultProperty) SetGoToSocialQuoteRequest(idx int, v vocab.GoToSocialQuoteRequest) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &ActivityStreamsResultPropertyIterator{
		alias:                        this.alias,
		gotosocialQuoteRequestMember: v,
