...
type GoToSocialQuoteRequest interface {
	...
	// QuoteRequest type. Note that this should not be used by app
	...
	// IsExtending returns true if the QuoteRequest type extends from the
	// other type.
	...
	// LessThan computes if this QuoteRequest is lesser, with an arbitrary but
	// stable determination.
	LessThan(o GoToSocialQuoteRequest) bool
