...
// URI/ID of a QuoteAuthorization permitting the Object this property is attached
// to.
type GoToSocialQuoteAuthorizationProperty interface {
	...
	LessThan(o GoToSocialQuoteAuthorizationProperty) bool
