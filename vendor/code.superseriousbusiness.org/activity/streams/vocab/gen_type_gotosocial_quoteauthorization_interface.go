...
type GoToSocialQuoteAuthorization interface {
	...
	// QuoteAuthorization type. Note that this should not be used by app
	...
	// IsExtending returns true if the QuoteAuthorization type extends from
	// the other type.
	...
	// LessThan computes if this QuoteAuthorization is lesser, with an
	// arbitrary but stable determination.
	LessThan(o GoToSocialQuoteAuthorization) bool
